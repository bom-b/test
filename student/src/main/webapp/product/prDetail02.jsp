				...
				<tr>
					<td class="col-lg-5">
						<div class="card picZoomer">
							<img alt="${bean.name}" src="./../image/images/${bean.image01}"
					...
					<td class="col-lg-1">
						...
						<!-- 그림 2번 -->
						<c:if test="${! empty bean.image02 }">
							<img alt="${bean.name}" src="./../image/images/${bean.image02}"
							class="car-img-top small_image rounded" width="180" height="180">
						</c:if>
						
						<!-- 그림 3번 -->
						<c:if test="${! empty bean.image03 }">
							<img alt="${bean.name}" src="./../image/images/${bean.image03}"
							class="car-img-top small_image rounded" width="180" height="180">
						</c:if>		
					</td>
					<td class="col-lg-6">
