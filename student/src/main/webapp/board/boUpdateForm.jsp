	...
	<div class="container">
		...
		<form action="<%=withFormTag%>" method="post">
			...
			<div class="input-group">
				...
				<input class="form-control" type="text" id="title" name="title" value="${requestScope.bean.subject}">
			</div>
			<div class="input-group">
				<span class="input-group-text">글내용</span> 
				<input class="form-control" type="text" id="content" name="content" value="${requestScope.bean.contents}">
			</div>
			<div class="input-group">
				<span class="input-group-text">비밀번호</span> <input
					class="form-control" type="password" id="password" name="password" value="${requestScope.bean.password}">
			</div>
			<div class="input-group">
				<span class="input-group-text">수정일자</span> 
				<input class="form-control" type="date" id="regdate" name="regdate" value="${requestScope.bean.regdate}">
			</div>
			<!-- <br/>
			<div class="mb-3">
