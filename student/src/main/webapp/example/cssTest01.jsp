...
<head>
	...
	<style type="text/css">
		...
		/* 라벨 태그를 모두 찾아서 글자 크기를 25 픽셀로 세팅*/
		label{font-size: 25px;}
		
		/* id 속성은 # 기호를 이용합니다. */
		#age{color:red; font-size: 40px;}
		#hobby{color: purple; font: bold;}
		
		/* class 속성은 .(dot) 기호를 이용합니다. */
		.mytarget{color: yellow; font-size: 40px; background-color: maroon;}
		...
		/* 스페이스는 특정요소의 하위 요소를 찾을 때 사용합니다. */
		#myform #age{background-color: aqua; color: threedlightshadow;}
		
		/* 라벨 요소 중에서 id가 hobby인 항목을 찾습니다. */
		label#hobby{background-color: threedlightshadow; color: silver;}
		label.mytarget{background-color: fuchsia; color: lime;}
		label.mytarget label.yourtarget{color: olive; font-size: 10px;}
	</style>
</head>
<body>
	<!-- html 주석 -->
	<h1>폼 양식</h1>
	<form id="myform"action="htmlText01To.jsp">
		<label>이름 : </label>
