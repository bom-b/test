		...
		<table border="1">
			<tr>
				...
				<td width="80%" align="left">
					<input type="text" name="name" style="width:400px; height:30px; font-size:20px;">
				</td>
			</tr>
			<tr>
				<td width="20%" align="center">나이</td>
				<td width="80%" align="left">
					<input type="text" name="age" style="width:400px; height:30px; font-size:20px;">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td width="20%" align="center">숨김 항목</td>
				<td width="80%" align="left">
			...
			<tr>
				...
				<td width="80%" align="left">
					<textarea name="comment" rows="10" cols="50" font-size="15px"></textarea>
				</td>
			</tr>
			<tr>
