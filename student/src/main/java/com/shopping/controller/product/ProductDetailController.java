...
public class ProductDetailController extends SuperClass {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			bean = dao.GetDataByPK(pnum);
			System.out.println(bean);
			request.setAttribute("bean", bean);
			
			/*
			 * String gotopage = super.getUrlInfomation("boList"); gotopage +=
			 * "&pageNumber=" + request.getParameter("pageNumber"); gotopage += "&pageSize="
			 * + request.getParameter("pageSize"); gotopage += "&mode=" +
			 * request.getParameter("mode"); gotopage += "&keyword=" +
